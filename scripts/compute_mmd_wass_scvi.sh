#!/bin/bash
#SBATCH --job-name=mmd_wass_scvi             # Job name
#SBATCH --output logs/mmd_wass_scvi_%J.log   # Output log file
...
export CP_DIR=/home/dfl32/scratch/training-runs/scvi
...
python compute_mmd_wass_scvi.py \
    --cp_dir $CP_DIR \
