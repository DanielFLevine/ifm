...
from compute_unconditional_corrs_diff import DiffusionFC, DDPM, inverse_transform_gpu
...
def main(args):
    ...
    adata = sc.read_h5ad("/home/dfl32/project/ifm/cinemaot_data/conditional_cinemaot/integrated_ifm_leiden_03.h5ad")
    expression_data = adata.X
    ...
    for repeat in range(args.num_repeats):
        ...
        with torch.no_grad():
            ...
            for step in tqdm(range(num_steps)):
                x_noisy = torch.randn(batch_size, args.input_dim).to(device)
        ...
        # Assign labels to generated data
        generated_labels = assign_labels_to_generated_data(pca_sampled_expression_data, sampled_labels, cells)

        # Compute KL divergence and total variation distance between the two distributions
