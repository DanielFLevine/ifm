#!/bin/bash
#SBATCH --job-name=ifm_pert_continue    # Job name
#SBATCH --output logs/ifm_pert_continue_%J.log  # Output log file
...
export SPACE=10
export CP_MODEL=/home/dfl32/scratch/training-runs/traincustomTrue-vaeTrue-klw0.3-EleutherAI/pythia-160m-idfmFalse-hdim_2d64idim_2d64nheads_2d4nblocks_2d2-space10-postvaeTrue-mlpencTrue-preweightsFalse-pca1000-datasizeNone-timepoints16-straightpathTrue-drop0.0ifm-2024-08-07_21-39-30
